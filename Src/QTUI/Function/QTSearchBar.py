...
class QTSearchBar(QWidget):
    def __init__(self, parent=None):
        ...
        # self.FilteringPanle = QTSelectMenu()

        self.Filteringbtn = QToolButton()
        # self.Filteringbtn.setMenu(self.FilteringPanle)
        self.Filteringbtn.setIcon(QIcon.fromTheme("document-new"))
        self.Filteringbtn.setIconSize(QSize(20, 20))
        layout.addWidget(self.Filteringbtn)
...
if __name__ == "__main__":
    ...
    # 把项目根目录加入 sys.path，假设 QTUI 是当前文件夹的父目录
